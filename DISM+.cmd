...
echo.===============================================================================
echo.
set /p imagefile=Vui lòng điền đường dẫn đến file install.wim trong bộ cài Windows: 
set /p index=Vui lòng điền số Index của phiên bản cần cài: 
set /p applydir=Vui lòng điền ký tự của phân vùng chứa Windows (bao gồm dấu ":"): 
set /p s=Vui lòng điền ký tự của phân vùng Boot (bao gồm dấu ":"): 
